...
// حد بالا دست‌ودل‌بازانه نیست: هر 70 نویسه‌ی فارسی یک پیامک حساب می‌شود، پس
// 300 نویسه یعنی تا حدود 5 پیامک از سهمیه‌ی خود tenant. بالاتر از این، هم
...
export function validateReminderBody(raw: unknown): TemplateValidation {
  ...
  // بدون تاریخ و ساعت، «یادآوری نوبت» عملا بی‌فایده است و مراجع نمی‌داند کی
