...
import { SUPPORT_EMAIL, PLATFORM_COMMISSION_PERCENT } from '@/lib/config'
      ...
      <div className="max-w-2xl mx-auto px-6 py-14">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-ink/90">
          ...
          <section>
            ...
            <p>
              پرداخت آنلاین از طریق درگاه دارای مجوز (زیبال) انجام می‌شود. معادل
              <span className="tnum"> {PLATFORM_COMMISSION_PERCENT}% </span>
              از مبلغ هر پرداخت آنلاین موفق، سهم نوبت‌لینک بابت خدمات پلتفرم است که هنگام تسویه از سهم
              ارائه‌دهنده کسر می‌شود؛ مابقی وجوه در بازه‌های تسویه‌ای که خود ارائه‌دهنده انتخاب می‌کند به
              حساب او واریز می‌گردد. این کارمزد از سهم ارائه‌دهنده کسر می‌شود و مبلغی اضافه بر قیمت
