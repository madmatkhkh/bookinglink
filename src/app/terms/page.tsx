        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-ink/90">
          ...
          <section>
            ...
            <p>
              ...
              ارائه‌دهنده کسر می‌شود؛ مابقی وجوه به‌صورت دوره‌ای با ارائه‌دهنده تسویه و به حساب او واریز
              می‌گردد. این کارمزد از سهم ارائه‌دهنده کسر می‌شود و مبلغی اضافه بر قیمت
