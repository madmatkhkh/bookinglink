      ...
      <div className="max-w-2xl mx-auto px-6 py-14">
        ...
        <div className="mt-8 space-y-7 text-sm leading-7 text-ink/90">
          ...
          <section>
            ...
            <p>
              پرداخت آنلاین از طریق درگاه دارای مجوز (زیبال) انجام می‌شود و وجه به حساب ارائه‌دهنده‌ی
              خدمت تسویه می‌گردد. در روش کارت‌به‌کارت، تراکنش مستقیما میان مراجع و ارائه‌دهنده است و
              نوبت‌لینک صرفا ثبت‌کننده‌ی اعلام پرداخت است. قواعد کنسلی و بازپرداخت هر مجموعه در صفحه‌ی
