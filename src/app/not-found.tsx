// صفحه‌ی 404 برندشده — قبلا کاربر صفحه‌ی خام انگلیسی خود Next را می‌دید که
// با هویت فارسی/RTL محصول در تضاد بود.
    ...
    <main className="min-h-screen bg-paper text-ink flex items-center justify-center px-6" dir="rtl">
      <div className="text-center max-w-sm">
        ...
        <p className="text-sm text-soot mt-2 leading-6">
          نشانی که وارد آن شدید وجود ندارد یا جابه‌جا شده است. اگر لینک یک متخصص را دنبال می‌کنید، املای نشانی را بررسی کنید.
        </p>
