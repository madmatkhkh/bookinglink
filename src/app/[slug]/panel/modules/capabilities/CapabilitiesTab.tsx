  ...
  <div className="space-y-4 pb-24">
   ...
   <section className="bg-white rounded-2xl border border-sand p-4 space-y-4">
    ...
    <div className="space-y-3">
     ...
     <p className="text-xs text-soot leading-relaxed">
      این متن پیش از نوبت به مراجع پیامک می‌شود. هر متن پیش از استفاده یک بار
      بررسی می‌شود؛ تا زمان تایید، یادآوری‌ها با متن پیش‌فرض ارسال می‌شوند —
      قطع نمی‌شوند.
      <br />
      سه جاگذار {'{name}'}، {'{date}'} و {'{time}'} باید در متن باشند.
     </p>
