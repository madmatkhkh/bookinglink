// ─────────────────────────────────────────────────────────────────────────────
// صفحه‌ی عمومیِ متخصص — بر اساسِ نیچ شاخه می‌زند:
//   • روانشناسی → کارتِ ورود به مصاحبه‌ی اولیه + پنلِ مراجع (سبکِ psych-booking)
//   • بقیه‌ی نیچ‌ها → لیستِ سرویس‌ها برای رزروِ مستقیم
// Server Component برای سریع‌ترین لود از WebViewِ اینستاگرام.
// ─────────────────────────────────────────────────────────────────────────────
...
// ═══ لندینگِ روانشناسی (سبکِ psych-booking، ریسپانسیو) ═══════════════
    ...
    <div className="min-h-screen bg-paper flex items-center justify-center p-4">
      <div className="max-w-sm w-full">
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-bold text-ink mb-1">{c.doctor_name || 'پنلِ نوبت‌دهی'}</h1>
        ...
        <div className="space-y-3">
          <Link href={`/${slug}/interview`}
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="text-xs text-soot">مراجع جدید؟ فرم را پر کنید و وقتِ مصاحبه بگیرید</div>
              </div>
          ...
          <Link href={`/${slug}/my`}
            ...
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-xl bg-accent/10 flex items-center justify-center text-2xl shrink-0">👤</div>
              <div className="flex-1">
                <div className="font-medium text-ink text-sm mb-0.5">ورود به پنلِ مراجع</div>
                <div className="text-xs text-soot">قبلاً پرونده دارید؟ با شماره‌ی موبایل وارد شوید</div>
              </div>
              <div className="text-sand text-lg">←</div>
            </div>
          </Link>
        ...
        <p className="text-center text-xs text-soot/70 mt-6">برای شروعِ درمان، ابتدا مصاحبه‌ی اولیه انجام می‌شود.</p>
