...
--     فقط روی دیتابیسی بزن که داده‌ی واقعی ندارد.
--
--  نحوه‌ی اجرا: کل این فایل را در Supabase → SQL Editor پیست کن و Run بزن.
--
--  این فایل دست‌نویس نیست — با pg_dump از روی اجرای واقعی همه‌ی مهاجرت‌ها
--  تولید شده، پس هیچ ستون، ایندکس یا قیدی از قلم نیفتاده. صحتش با تست
--  رفت‌وبرگشت تایید شده: اجرای این فایل روی دیتابیس خالی، دقیقا همان
--  ساختاری را می‌سازد که زنجیره‌ی کامل مهاجرت‌ها می‌ساخت.
-- ═══════════════════════════════════════════════════════════════════════════

-- پاک‌سازی کامل — schema دوباره توسط بخش ساختار ساخته می‌شود
drop schema if exists public cascade;


-- ═══════════════════════════════════════════════════════════════════════════
--  ساختار (جداول، ایندکس‌ها، قیدها، RLS)
-- ═══════════════════════════════════════════════════════════════════════════
...
CREATE TABLE public.invoices (
    ...
    vat_rate numeric DEFAULT 10 NOT NULL,
    subscription_base bigint DEFAULT 0 NOT NULL,
    subscription_vat bigint DEFAULT 0 NOT NULL,
    txn_fee_base bigint DEFAULT 0 NOT NULL,
    txn_fee_vat bigint DEFAULT 0 NOT NULL,
    txn_count integer DEFAULT 0 NOT NULL,
    total_base bigint DEFAULT 0 NOT NULL,
    total_vat bigint DEFAULT 0 NOT NULL,
...
--
-- Name: psy_appointment_requests; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.psy_appointment_requests (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    resource_id uuid,
...
--
-- Name: psy_cancelled_slots; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: psy_extra_charges; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.psy_extra_charges (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    resource_id uuid,
    case_number text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT psy_extra_charges_amount_check CHECK ((amount > 0))
);
...
CREATE TABLE public.psy_packages (
    ...
    primary_meet_channel text,
    secondary_office_location text,
    secondary_meet_channel text
);
...
--
-- Name: psy_refunds; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.psy_refunds (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    tenant_id uuid NOT NULL,
    resource_id uuid,
    case_number text NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    bank_ref_number text,
    CONSTRAINT psy_refunds_amount_check CHECK ((amount > 0))
);
...
CREATE TABLE public.psy_resource_profiles (
    ...
    terms jsonb DEFAULT '{"extra": "", "enabled": false}'::jsonb NOT NULL,
    commission_percent_override numeric,
    first_stage_label text DEFAULT 'مصاحبه'::text NOT NULL,
    stage_presets jsonb DEFAULT '[]'::jsonb NOT NULL
);
...
--
-- Name: slot_locks; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: sms_credits; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.sms_credits (
    ...
    amount integer NOT NULL,
    note text,
    created_by text DEFAULT 'super'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.sms_log (
    ...
    tenant_id uuid NOT NULL,
    kind text NOT NULL,
    charged text DEFAULT 'quota'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);
...
CREATE TABLE public.tenant_profiles (
    ...
    CONSTRAINT tenant_profiles_reminder_lead_check CHECK (((reminder_lead_hours >= 1) AND (reminder_lead_hours <= 48))),
...
CREATE TABLE public.tenants (
    ...
    CONSTRAINT tenants_plan_check CHECK ((plan = ANY (ARRAY['free'::text, 'base'::text, 'pro'::text, 'team'::text]))),
...
--
-- Name: psy_appointment_requests psy_appointment_requests_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_appointment_requests
    ADD CONSTRAINT psy_appointment_requests_pkey PRIMARY KEY (id);
...
--
-- Name: psy_extra_charges psy_extra_charges_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_extra_charges
    ADD CONSTRAINT psy_extra_charges_pkey PRIMARY KEY (id);
...
--
-- Name: psy_refunds psy_refunds_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_refunds
    ADD CONSTRAINT psy_refunds_pkey PRIMARY KEY (id);
...
--
-- Name: settlement_items settlement_items_ledger_entry_id_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.settlement_items
    ADD CONSTRAINT settlement_items_ledger_entry_id_key UNIQUE (ledger_entry_id);
...
--
-- Name: slot_locks slot_locks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: sms_credits sms_credits_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: tenants tenants_slug_check; Type: CHECK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE public.tenants
    ADD CONSTRAINT tenants_slug_check CHECK (((slug ~ '^[a-z0-9][a-z0-9_-]{1,38}[a-z0-9]$'::text) AND (slug !~ '[_-]{2}'::text))) NOT VALID;
...
--
-- Name: invoices_tenant_period_uniq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX invoices_tenant_period_uniq ON public.invoices USING btree (tenant_id, period_key);
...
--
-- Name: psy_appointment_requests_case_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_appointment_requests_case_idx ON public.psy_appointment_requests USING btree (tenant_id, case_number);

--
-- Name: psy_appointment_requests_pending_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_appointment_requests_pending_idx ON public.psy_appointment_requests USING btree (tenant_id, status);

--
-- Name: psy_cancelled_slots_lookup; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_cancelled_slots_lookup ON public.psy_cancelled_slots USING btree (tenant_id, resource_id, session_date);
...
--
-- Name: psy_extra_charges_case_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_extra_charges_case_idx ON public.psy_extra_charges USING btree (tenant_id, case_number);
...
--
-- Name: psy_patient_messages_case_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_patient_messages_case_idx ON public.psy_patient_messages USING btree (tenant_id, case_number);
...
--
-- Name: psy_refunds_case_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX psy_refunds_case_idx ON public.psy_refunds USING btree (tenant_id, case_number);
...
--
-- Name: settlement_items_settlement_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: slot_locks_expiry; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX slot_locks_expiry ON public.slot_locks USING btree (expires_at) WHERE (status = 'pending'::text);

--
-- Name: slot_locks_source; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX slot_locks_source ON public.slot_locks USING btree (source_table, source_id);

--
-- Name: slot_locks_uniq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX slot_locks_uniq ON public.slot_locks USING btree (tenant_id, resource_id, session_date, session_time);

--
-- Name: sms_credits_tenant; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX sms_credits_tenant ON public.sms_credits USING btree (tenant_id);

--
-- Name: sms_log_tenant_month; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX sms_log_tenant_month ON public.sms_log USING btree (tenant_id, charged, created_at);

--
-- Name: sms_templates_status_idx; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX sms_templates_status_idx ON public.sms_templates USING btree (status);

--
-- Name: sms_templates_tenant_kind_uniq; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX sms_templates_tenant_kind_uniq ON public.sms_templates USING btree (tenant_id, kind);
...
--
-- Name: psy_appointment_requests psy_appointment_requests_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_appointment_requests
    ADD CONSTRAINT psy_appointment_requests_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.resources(id) ON DELETE SET NULL;

--
-- Name: psy_appointment_requests psy_appointment_requests_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_appointment_requests
    ADD CONSTRAINT psy_appointment_requests_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: psy_extra_charges psy_extra_charges_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_extra_charges
    ADD CONSTRAINT psy_extra_charges_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.resources(id) ON DELETE SET NULL;

--
-- Name: psy_extra_charges psy_extra_charges_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_extra_charges
    ADD CONSTRAINT psy_extra_charges_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: psy_refunds psy_refunds_resource_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_refunds
    ADD CONSTRAINT psy_refunds_resource_id_fkey FOREIGN KEY (resource_id) REFERENCES public.resources(id) ON DELETE SET NULL;

--
-- Name: psy_refunds psy_refunds_tenant_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.psy_refunds
    ADD CONSTRAINT psy_refunds_tenant_id_fkey FOREIGN KEY (tenant_id) REFERENCES public.tenants(id) ON DELETE CASCADE;
...
--
-- Name: settlement_items settlement_items_ledger_entry_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.settlement_items
    ADD CONSTRAINT settlement_items_ledger_entry_id_fkey FOREIGN KEY (ledger_entry_id) REFERENCES public.ledger_entries(id);
...
-- ═══════════════════════════════════════════════════════════════════════════
--  داده‌های اولیه (کاتالوگ ماژول‌ها، نیچ‌ها، تنظیمات پلتفرم)
-- ═══════════════════════════════════════════════════════════════════════════
...
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('card_to_card', 'پرداخت کارت‌به‌کارت', 'کارت‌به‌کارت با رسید + تب تایید پرداخت‌ها', 'platform', '[]', false, true, 'included', 0, true, 20);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('discount_codes', 'کدهای تخفیف', 'ساخت و مدیریت کد تخفیف', 'platform', '["pay_online|card_to_card"]', true, true, 'included', 0, true, 50);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('analytics', 'تحلیل کسب‌وکار', 'داشبورد درآمد، no-show، رشد پرونده‌ها', 'platform', '[]', true, true, 'included', 0, true, 80);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('reminders', 'یادآور پیامکی نوبت', 'ارسال خودکار یادآور قبل از نوبت (cron)', 'platform', '[]', true, false, 'included', 0, true, 100);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('online_meeting', 'جلسه‌ی آنلاین (لینک)', 'لینک Meet/Zoom/WhatsApp/Bale/تلفن برای جلسه‌های آنلاین', 'platform', '[]', true, false, 'included', 0, true, 110);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('psy_stages', 'مراحل پیش‌ازدرمان', 'فلوی آزاد و تکرارپذیر مصاحبه/ارزیابی/دلخواه', 'psychology', '[]', true, false, 'included', 0, true, 210);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('psy_packages', 'پروتکل‌های درمان', 'پکیج جلسات ماهانه', 'psychology', '[]', true, false, 'included', 0, true, 220);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('clinical_notes', 'یادداشت بالینی (SOAP/DAP)', 'یادداشت ساختاریافته‌ی بالینی per-جلسه', 'psychology', '[]', true, false, 'included', 0, true, 230);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('intake_form', 'فرم‌بیلدر رزرو', 'بخش/سوال/منطق شرطی — کاندید ارتقا به سطح پلتفرم', 'psychology', '[]', true, false, 'included', 0, true, 240);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('custom_domain', 'دامنه‌ی اختصاصی', 'اتصال دامنه‌ی خود مشتری (هنوز ساخته نشده)', 'platform', '[]', false, false, 'included', 0, false, 130);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('multi_therapist', 'چندپرسنلی (تیم)', 'ورود مستقل پرسنل، تب پرسنل، انتخابگر پرسنل در رزرو', 'platform', '[]', false, true, 'included', 0, true, 120);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('patient_self_cancel', 'کنسل توسط مراجع', 'کنسل از پنل مشتری طبق سیاست کنسلی هر مجموعه', 'platform', '[]', true, true, 'included', 0, true, 30);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('patient_buy_extra_session', 'خرید جلسه‌ی جایگزین', 'خرید جلسه‌ی اضافه از پنل مشتری', 'platform', '["pay_online|card_to_card"]', true, true, 'included', 0, true, 40);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('waitlist', 'لیست انتظار', 'ثبت‌نام مشتری وقتی ظرفیت خالی نیست + اطلاع‌رسانی دستی', 'platform', '[]', true, true, 'included', 0, true, 60);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('reviews', 'نظرات و امتیاز مشتریان', 'ثبت نظر توسط مشتری + مدیریت و انتشار', 'platform', '[]', true, true, 'included', 0, true, 70);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('campaigns', 'کمپین پیامک/ایمیل', 'پیام گروهی به مشتریان (سگمنت غیرفعال 30/90 روز)', 'platform', '[]', true, true, 'included', 0, true, 90);
INSERT INTO public.modules (key, display_name, description, scope, depends_on, default_on, enforced, pricing_type, price, is_active, sort_order) VALUES ('pay_online', 'درگاه پرداخت نوبت‌لینک', 'درگاه پرداخت آنلاین اختصاصی، تایید خودکار، کارمزد پلتفرم', 'platform', '[]', false, false, 'included', 0, true, 10);

--
-- Data for Name: niches; Type: TABLE DATA; Schema: public; Owner: -
--
...
INSERT INTO public.platform_settings (key, value, updated_at) VALUES ('commission_percent', '7', '2026-07-23 09:56:03.4691+00');
INSERT INTO public.platform_settings (key, value, updated_at) VALUES ('plans_enforced', 'true', '2026-07-23 09:56:03.533337+00');
INSERT INTO public.platform_settings (key, value, updated_at) VALUES ('plan_sms_quotas', '{"pro": 500, "base": 150, "team": 1500}', '2026-07-23 09:56:03.559457+00');
INSERT INTO public.platform_settings (key, value, updated_at) VALUES ('plan_prices', '{"pro": 890000, "base": 390000, "team": 1900000, "enabled": false}', '2026-07-23 09:56:03.560591+00');
INSERT INTO public.platform_settings (key, value, updated_at) VALUES ('plan_fees', '{"plans": {"pro": {"pct": 2.5, "floor": 3000}, "base": {"pct": 3, "floor": 3000}, "team": {"pct": 2, "floor": 3000}}, "vat_percent": 10}', '2026-07-23 09:56:03.572728+00');
